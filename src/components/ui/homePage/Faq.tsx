    ...
    return (
        <section className="my-16">
            ...
            <div className="collapse collapse-arrow bg-base-200">
                ...
                <div className="collapse-content bg-white border">
            ...
            <div className="collapse collapse-arrow bg-base-200">
                ...
                <div className="collapse-title text-xl border-2 font-medium">What are the different types of mechanical switches, and how do I choose the right one for me?</div>
                <div className="collapse-content bg-white border">
            ...
            <div className="collapse collapse-arrow bg-base-200">
                <input type="radio" name="my-accordion-2" />
                <div className="collapse-title border-2 text-xl font-medium">How do I maintain and clean my mechanical keyboard?</div>
                <div className="collapse-content bg-white border">
